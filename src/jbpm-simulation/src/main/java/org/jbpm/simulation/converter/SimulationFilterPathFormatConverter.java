        ...
        if (eventDefinitions != null) {
            ...
            for (EventDefinition edef : eventDefinitions) {
                if (edef instanceof SignalEventDefinition) {
                    ...
                    be =  ((MessageEventDefinition) edef).getMessageRef();
                    if(be!= null) key = "Message-" + be.getId();
                    ...
                    be =  ((CompensateEventDefinition) edef).getActivityRef();
                    if(be!= null) key =  be.getId();
                } else if (edef instanceof ErrorEventDefinition) {
                    be =  ((ErrorEventDefinition) edef).getErrorRef();
                    if(be!= null) key = "Error-" + be.getId();
                }
                if (key != null) {
                    break;
                }
